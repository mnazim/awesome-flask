...
- Framework
    ...
    - [Samavar](https://github.com/mnazim/samavaar) - Flask-SQLAlchemy, Flask-Security, SQL + NoSQL. Working login/register. Stubs for common pages like dashboad, profile, settings, etc. and then some. 
- Admin
